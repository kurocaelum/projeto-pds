 ...
 <div class="container">
 	<form id="form_servico" action="" method="post">
		...
		<div class="form-group">
			...
			<div class="form-group">
				<label for="form_input_largura">Largura</label>
				<input name="largura" type="text" class="form-control" id="form_input_largura" placeholder="">
			</div>

			<div class="form-group">
				<label for="form_input_comprimento">Comprimento</label>
				<input name="comprimento" type="text" class="form-control" id="form_input_comprimento" placeholder="">
			</div>
